# =============================================================================
# STEP 2: CREATE SIMPLE PRESENTATION WITH REAL DATA AND FIGURES
# Let's create a working presentation step by step
# =============================================================================
...
cat("=== STEP 2: CREATING SIMPLE PRESENTATION ===\n")

# Create output directory
output_dir <- "step2_simple_presentation"
...
# Create simple R Markdown with real data
simple_rmd <- paste0("
---
...
# Write the simple R Markdown
writeLines(simple_rmd, file.path(output_dir, "simple_presentation.Rmd"))

# Render the HTML
cat("Rendering simple HTML presentation...\n")
tryCatch({
  render(file.path(output_dir, "simple_presentation.Rmd"), 
         output_file = "simple_presentation.html",
...
cat("🌐 HTML file:", file.path(output_dir, "simple_presentation.html"), "\n")
cat("🔍 Check if real data and figures are displaying properly\n")
