# =============================================================================
# COMPREHENSIVE HTML PRESENTATION: COMPLETE SNV ANALYSIS IN miRNAs
# This script creates a comprehensive HTML presentation with all findings,
# processes, experiments, and discoveries from the entire analysis.
# =============================================================================
...
# Create output directory for the comprehensive HTML presentation
output_dir <- "comprehensive_html_presentation"
if (!dir.exists(output_dir)) {
  dir.create(output_dir, recursive = TRUE)
}

cat("=== COMPREHENSIVE HTML PRESENTATION ===\n")
cat("Creating comprehensive HTML presentation with all findings\n\n")

# --- Copy custom CSS file ---
file.copy("custom.css", file.path(output_dir, "custom.css"), overwrite = TRUE)

# --- Create the comprehensive HTML content ---
html_content <- c(
  "<!DOCTYPE html>",
  "<html lang='en'>",
  "<head>",
  ...
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/figures/01_preprocessing_pipeline_flow.png' alt='Preprocessing Pipeline Flow'>",
  ...
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/analysis_figures/01_analytical_approaches_overview.png' alt='Analytical Approaches Overview'>",
  ...
  "",
  "            <div class='figure'>",
  "                <img src='distribucion_por_posicion.pdf' alt='Distribution by Position' style='width: 80%;'>",
  ...
  "            <div class='figure'>",
  "                <img src='boxplot_vafs_posicion_6.pdf' alt='VAFs Position 6' style='width: 80%;'>",
  "                <div class='figure-caption'>Figure 4: Boxplot of VAFs for SNVs at position 6, comparing ALS and Control groups.</div>",
  "            </div>",
  "",
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/analysis_figures/02_positional_analysis_results.png' alt='Positional Analysis Results'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_oxidative_load/01_boxplot_oxidative_score.png' alt='Oxidative Load Boxplot'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_oxidative_load/04_correlation_heatmap.png' alt='Oxidative Load Correlation'>",
  "                <div class='figure-caption'>Figure 7: Correlation heatmap of oxidative load metrics and clinical variables.</div>",
  "            </div>",
  "",
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/analysis_figures/03_clinical_correlations.png' alt='Clinical Correlations'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_robust_pca/01_pca_scatter_pc1_pc2.png' alt='PCA Scatter Plot'>",
  "                <div class='figure-caption'>Figure 9: PCA scatter plot showing PC1 vs PC2, colored by group (ALS vs Control).</div>",
  "            </div>",
  "",
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/analysis_figures/04_pca_variance_explained.png' alt='PCA Variance Explained'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_robust_pca/04_position_contributions_heatmap.png' alt='PCA Contributions'>",
  ...
  "",
  "            <div class='figure'>",
  "                <img src='figures_mir6133_validation/01_vaf_distribution_mir6133_6gt.png' alt='miR-6133 Validation'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_clinical_correlation/01_boxplot_edad_grupo.png' alt='Age Distribution'>",
  "                <div class='figure-caption'>Figure 13: Boxplot showing age distribution across ALS and Control groups.</div>",
  "            </div>",
  "",
  "            <div class='figure'>",
  "                <img src='figures_clinical_correlation/02_boxplot_sexo_grupo.png' alt='Sex Distribution'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_clinical_correlation/03_curva_roc.png' alt='ROC Curve'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_pathways/01_family_contributions_heatmap.png' alt='Family Contributions'>",
  ...
  "",
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/analysis_figures/05_biological_findings_summary.png' alt='Biological Findings'>",
  ...
  "            <div class='figure'>",
  "                <img src='figures_pathways/04_miRNA_network.png' alt='miRNA Network'>",
  ...
  "            <h3>VAFs Heatmap</h3>",
  "            <div class='figure'>",
  "                <img src='heatmap_vafs_posiciones_significativas.pdf' alt='VAFs Heatmap' style='width: 80%;'>",
  ...
  "            <div class='figure'>",
  "                <img src='heatmap_zscores_posiciones_significativas.pdf' alt='Z-scores Heatmap' style='width: 80%;'>",
  ...
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/integration_figures/01_methodological_comparison.png' alt='Methodological Comparison'>",
  ...
  "",
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/integration_figures/02_biological_integration.png' alt='Biological Integration'>",
  ...
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/integration_figures/03_clinical_variables_distribution.png' alt='Clinical Variables Distribution'>",
  "                <div class='figure-caption'>Figure 23: Distribution of key clinical variables from the original paper (GSE168714).</div>",
  "            </div>",
  "",
  "            <div class='figure'>",
  "                <img src='comprehensive_documentation/integration_figures/04_sample_overlap_analysis.png' alt='Sample Overlap Analysis'>",
...
cat("✅ Comprehensive HTML presentation created successfully!\n")
cat("📁 Output directory:", output_dir, "\n")
cat("📄 HTML file:", html_file_path, "\n")
cat("🌐 Open the HTML file in a web browser to view the complete presentation\n\n")

# --- Create a summary of what was included ---
cat("=== PRESENTATION CONTENTS SUMMARY ===\n")
cat("The comprehensive HTML presentation includes:\n\n")

cat("📊 FIGURES INCLUDED:\n")
cat("  - Preprocessing pipeline flow\n")
cat("  - Positional analysis results\n")
cat("  - Oxidative load comparisons\n")
cat("  - PCA analysis results\n")
cat("  - Technical validation plots\n")
cat("  - Clinical correlation analysis\n")
cat("  - Pathway and network analysis\n")
cat("  - VAF and Z-score heatmaps\n")
cat("  - Integration with original paper\n")
cat("  - Comprehensive documentation figures\n\n")

cat("📋 SECTIONS INCLUDED:\n")
cat("  1. Introduction and Objectives\n")
cat("  2. Methodology: Data Preprocessing\n")
cat("  3. Key Analytical Approaches\n")
cat("  4. Positional Analysis\n")
cat("  5. Differential Oxidative Load\n")
cat("  6. Robust Principal Component Analysis\n")
cat("  7. Technical Validation\n")
cat("  8. Clinical Correlation Analysis\n")
cat("  9. Pathway and miRNA Network Analysis\n")
cat("  10. Discussion: Validity of VAFs and Z-scores\n")
cat("  11. Integration with Original Paper\n")
cat("  12. Conclusions and Future Directions\n\n")

cat("🎯 KEY FINDINGS HIGHLIGHTED:\n")
cat("  - Oxidative load paradox (higher in controls)\n")
cat("  - Position 6 as hotspot with other positions more significant\n")
cat("  - miR-181 family as most contributive\n")
cat("  - Technical artifact identification and validation\n")
cat("  - Integration with GSE168714 findings\n")
cat("  - Publication potential assessment\n\n")

cat("📈 STATISTICAL RESULTS:\n")
cat("  - p < 0.001 for oxidative load differences\n")
cat("  - p_adj < 0.05 for positions 2,4,5,7,8\n")
cat("  - AUC ~0.7 for diagnostic score\n")
cat("  - Partial separation in PCA analysis\n")
cat("  - Multiple significant clinical correlations\n\n")

cat("🔬 METHODOLOGICAL INNOVATIONS:\n")
cat("  - Systematic artifact detection\n")
cat("  - Robust preprocessing pipeline\n")
cat("  - Multi-level quality control\n")
cat("  - Comprehensive validation approach\n")
cat("  - Integration with existing literature\n\n")

cat("=== END OF COMPREHENSIVE HTML PRESENTATION ===\n")
