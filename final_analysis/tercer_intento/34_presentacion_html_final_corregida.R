# =============================================================================
# PRESENTACIÓN HTML FINAL CORREGIDA: ANÁLISIS DE SNVs EN miRNAs
# =============================================================================
...
# Crear directorio para la presentación HTML final
output_dir <- "presentacion_html_final"
if (!dir.exists(output_dir)) {
  dir.create(output_dir, recursive = TRUE)
}

cat("=== PRESENTACIÓN HTML FINAL CORREGIDA ===\n")
cat("Generando presentación HTML con imágenes reales disponibles...\n\n")

# --- Crear el archivo R Markdown dinámicamente ---
rmd_content <- c(
  "---",
...
rmd_filename <- file.path(output_dir, "presentacion_final_corregida.Rmd")
writeLines(rmd_content, rmd_filename)

# Renderizar el R Markdown a HTML
cat("Generando presentación HTML final corregida...\n")
rmarkdown::render(
  input = rmd_filename,
  output_format = "ioslides_presentation",
  output_file = "presentacion_final_corregida.html",
...
cat("=== RESUMEN DE LA PRESENTACIÓN HTML FINAL CORREGIDA ===\n")
cat("Presentación generada: ", file.path(output_dir, "presentacion_final_corregida.html"), "\n")
cat("Archivos incluidos:\n")
cat("- ", rmd_filename, " (código fuente)\n")
cat("- custom.css (estilos personalizados)\n")
cat("- ", file.path(output_dir, "presentacion_final_corregida.html"), " (presentación final)\n\n")

cat("✅ Presentación HTML final corregida generada exitosamente!\n")
cat("📁 Directorio: ", output_dir, "/\n")
cat("🌐 Archivo principal: presentacion_final_corregida.html\n")
cat("📄 Total de slides: 20+\n")
cat("🖼️  Incluye todas las imágenes reales disponibles del análisis\n")
cat("🔗 Conexión con paper original GSE168714\n")
cat("📊 Análisis de metadatos y miR-181\n\n")

cat("=== FIN DE LA PRESENTACIÓN HTML FINAL CORREGIDA ===\n")
