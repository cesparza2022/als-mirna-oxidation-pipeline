# =============================================================================
# PRESENTACIÓN HTML FINAL FUNCIONAL: ANÁLISIS DE SNVs EN miRNAs
# =============================================================================
...
cat("=== PRESENTACIÓN HTML FINAL FUNCIONAL ===\n")
...
rmd_filename <- file.path(output_dir, "presentacion_final_funcional.Rmd")
writeLines(rmd_content, rmd_filename)

# Renderizar el R Markdown a HTML
cat("Generando presentación HTML final funcional...\n")
rmarkdown::render(
  input = rmd_filename,
  output_format = "ioslides_presentation",
  output_file = "presentacion_final_funcional.html",
...
cat("=== RESUMEN DE LA PRESENTACIÓN HTML FINAL FUNCIONAL ===\n")
cat("Presentación generada: ", file.path(output_dir, "presentacion_final_funcional.html"), "\n")
cat("Archivos incluidos:\n")
cat("- ", rmd_filename, " (código fuente)\n")
cat("- custom.css (estilos personalizados)\n")
cat("- ", file.path(output_dir, "presentacion_final_funcional.html"), " (presentación final)\n\n")

cat("✅ Presentación HTML final funcional generada exitosamente!\n")
cat("📁 Directorio: ", output_dir, "/\n")
cat("🌐 Archivo principal: presentacion_final_funcional.html\n")
cat("📄 Total de slides: 18+\n")
...
cat("=== FIN DE LA PRESENTACIÓN HTML FINAL FUNCIONAL ===\n")
