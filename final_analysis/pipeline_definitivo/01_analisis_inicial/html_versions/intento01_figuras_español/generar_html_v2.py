...
"""
==============================================================================
GENERADOR HTML V2 - CON FIGURAS INSERTADAS AUTOMÁTICAMENTE
==============================================================================

Mejoras sobre V1:
  ✅ Inserta figuras automáticamente
  ✅ Detecta menciones a pasos y carpetas
  ✅ Crea galerías de figuras
...
def find_figures_for_step(step_name):
    ...
    # Buscar en carpetas organizadas
    paso_dirs = [
        f"../../figures/{step_name}/",
    ...
    for pdir in paso_dirs:
        if os.path.exists(pdir):
            pngs = glob(f"{pdir}*.png")
            for png in pngs:
                rel_path = os.path.relpath(png, ".")
...
<figure class="gallery-item">
    <img src="{fig['path']}" alt="{fig['name']}" class="result-figure" loading="lazy">
...
for i, line in enumerate(md_lines):
    ...
    if line.startswith('### ') and ('Step' in line or 'Stepstep' in line.lower()):
...
print("\n💾 Paso 4: Guardando HTML mejorado...")

html_file = Path("reporte_completo_con_figuras.html")
...
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
print("✅ HTML V2 GENERADO EXITOSAMENTE\n")
print("📄 Archivo: reporte_completo_con_figuras.html")
print(f"📊 Tamaño: {file_size} KB\n")
print("🎨 Características:")
print("   • Estructura HTML5 completa")
print("   • CSS moderno y responsive")
print("   • Navegación interactiva")
print("   • Smooth scroll")
print("   • Zoom de figuras al click")
print(f"   • ~{figures_count} figuras insertadas automáticamente\n")
print("🌐 Para abrir:")
print("   open reporte_completo_con_figuras.html\n")
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
