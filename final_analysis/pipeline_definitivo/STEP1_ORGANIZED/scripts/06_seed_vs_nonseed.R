...
write_csv(summary_tbl, file.path("data", "TABLE_1.F_seed_vs_nonseed.csv"))
...
ggsave(file.path("figures", "step1_panelF_seed_interaction.png"), p, width = 10, height = 7, dpi = 300, bg = "white")
