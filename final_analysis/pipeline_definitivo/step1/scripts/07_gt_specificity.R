...
write_csv(spec_tbl, file.path(table_dir, "TABLE_1.G_gt_specificity.csv"))
...
ggsave(file.path(figure_dir, "step1_panelG_gt_specificity.png"), p, width = 9, height = 7, dpi = 300, bg = "white")
