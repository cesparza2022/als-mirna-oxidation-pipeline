# HTML FINAL CON FIGURAS BASE + VAF REALES
...
<div class='highlight'>
  <strong>🔬 Datos VAF Reales:</strong> Las figuras avanzadas ahora utilizan datos reales de Variant Allele Frequency (VAF) del pipeline, mostrando valores decimales que representan la frecuencia de variantes en las muestras. Esto proporciona una representación más precisa de la carga mutacional.
</div>
...
cat("✅ HTML FINAL CON DATOS VAF REALES CREADO\n")
