...
# Figures 2.13-2.15: Density Heatmaps (using ComplexHeatmap version)
cat("📊 Generating Figures 2.13-2.15: Density Heatmaps...\n")
t13 <- Sys.time()
# Use the correct script that generates the same figures as HTML_VIEWERS_FINALES
source("generate_HEATMAP_DENSITY_GT.R", local = TRUE)
