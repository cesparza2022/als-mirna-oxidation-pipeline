...
# Paths (relative to step1_5/scripts/)
...
write.csv(data_output, file.path(output_dir, "ALL_MUTATIONS_VAF_FILTERED.csv"), row.names = FALSE)
cat("   ✅ outputs/tables/ALL_MUTATIONS_VAF_FILTERED.csv\n")
...
if (length(filter_log) > 0) {
  ...
  write.csv(filter_df, file.path(output_dir, "vaf_filter_report.csv"), row.names = FALSE)
  cat(sprintf("   ✅ outputs/tables/vaf_filter_report.csv (%d filtered events)\n", nrow(filter_df)))
  ...
  write.csv(stats_by_type, file.path(output_dir, "vaf_statistics_by_type.csv"), row.names = FALSE)
  cat("   ✅ outputs/tables/vaf_statistics_by_type.csv\n")
  ...
  write.csv(stats_by_mirna, file.path(output_dir, "vaf_statistics_by_mirna.csv"), row.names = FALSE)
  cat("   ✅ outputs/tables/vaf_statistics_by_mirna.csv\n")
}
...
cat("\n📁 OUTPUT FILES:\n")
cat("   • outputs/tables/ALL_MUTATIONS_VAF_FILTERED.csv (main dataset)\n")
cat("   • outputs/tables/vaf_filter_report.csv (detailed log)\n")
cat("   • outputs/tables/vaf_statistics_by_type.csv (stats by mutation type)\n")
cat("   • outputs/tables/vaf_statistics_by_mirna.csv (stats by miRNA)\n")
