...
# Script para analizar z-score de mutaciones G>T en posiciones 5 y 6
...
cat("🧬 ANÁLISIS DE Z-SCORE PARA POSICIONES 5 Y 6 (HOTSPOTS G>T)\n")
cat("==========================================================\n\n")
...
cat("✅ Heatmap guardado en: outputs/zscore_heatmap_positions_5_6.pdf\n\n")
