# =============================================================================
# ANÁLISIS SIMPLE DE HEATMAPS - G>T MUTATIONS
# =============================================================================
# Script simplificado para generar heatmaps específicos con:
...
cat("🔬 ANÁLISIS SIMPLE DE HEATMAPS G>T\n")
cat("==================================\n\n")
...
gt_mutations <- df_main %>%
  filter(str_detect(df_main[["pos:mut"]], "GT$")) %>%
  mutate(
    miRNA_name = df_main[["miRNA name"]],
    pos = as.integer(str_extract(df_main[["pos:mut"]], "^([0-9]+):", group = 1)),
    mutation_type = "G>T",
