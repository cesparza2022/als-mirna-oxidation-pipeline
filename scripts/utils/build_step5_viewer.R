...
# ============================================================================
# Generates HTML viewer for Step 5 miRNA Family Analysis results
# ============================================================================
...
# Load family analysis data for summary
...
<html>
<head>
  <title>Step 5: miRNA Family Analysis Viewer</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="stats">
        <div class="stat-box">
          ...
          <div class="stat-label">miRNA Families</div>
        </div>
        <div class="stat-box">
          <div class="stat-number">', n_miRNAs, '</div>
          <div class="stat-label">Total miRNAs</div>
        </div>
      </div>
    </div>
    ...
    <div class="figure">
      ...
      <div class="figure-caption">Oxidation patterns by miRNA family (ALS vs Control)</div>
    </div>

    <h2>📊 Panel B: Family Heatmap</h2>
    <div class="figure">
      <img src="', encode_image(fig_b), '" alt="Family Heatmap">
      <div class="figure-caption">Heatmap showing oxidation patterns across miRNA families</div>
    </div>

    <div class="summary" style="margin-top: 40px;">
      <h2>📋 Available Tables</h2>
      <ul>
        <li><strong>S5_family_summary.csv</strong>: Summary statistics by family</li>
        <li><strong>S5_family_comparison.csv</strong>: Family comparison (ALS vs Control)</li>
      </ul>
    </div>
  </div>
</body>
